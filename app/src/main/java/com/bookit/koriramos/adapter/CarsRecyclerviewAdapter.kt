...
import com.bookit.koriramos.adapter.CarsRecyclerviewAdapter.CarsRecyclerviewAdapterViewHolder

class CarsRecyclerviewAdapter(val context: Context, val cars: List<Car>) :
	...
	override fun onCreateViewHolder(
		...
		return CarsRecyclerviewAdapterViewHolder(
